...
namespace Business.Concrete
{
    public class PersonManager : IApplicantService
    {
        ...
        public bool CheckPerson(Person person)
        {
            ...
            return client.TCKimlikNoDogrulaAsync(
            new TCKimlikNoDogrulaRequest(new TCKimlikNoDogrulaRequestBody(person.NationalIdentity, person.FirstName.ToUpper(), person.LastName.ToUpper(), person.BirthYear)))
